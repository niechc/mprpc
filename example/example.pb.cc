...
const char descriptor_table_protodef_example_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "iceRpc\0226\n\005Login\022\025.example.LoginRequest\032\026"
  ".example.LoginResponseB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_example_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_example_2eproto = {
    false, false, 275, descriptor_table_protodef_example_2eproto,
    "example.proto",
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* ExampleServiceRpc::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* ExampleServiceRpc::GetDescriptor() {
  return descriptor();
}

void ExampleServiceRpc::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void ExampleServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& ExampleServiceRpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& ExampleServiceRpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
ExampleServiceRpc_Stub::ExampleServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
ExampleServiceRpc_Stub::ExampleServiceRpc_Stub(
...
void ExampleServiceRpc_Stub::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
