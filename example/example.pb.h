...
class ExampleServiceRpc_Stub;

class ExampleServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline ExampleServiceRpc() {};
 public:
  virtual ~ExampleServiceRpc();

  typedef ExampleServiceRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(ExampleServiceRpc);
};

class ExampleServiceRpc_Stub : public ExampleServiceRpc {
 public:
  ExampleServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  ExampleServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~ExampleServiceRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements ExampleServiceRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(ExampleServiceRpc_Stub);
};
